...
with the \emph{Signal} server. I have submitted a pull request to fix this: \url{https://github.com/Turasa/libsignal-service-java/pull/28}.
...
\begin{itemize}
	...
	\item How NHS App AWS dependency, is difficult to test
	\item Exposure notification "Only approved government public health authorities can access the APIs"
