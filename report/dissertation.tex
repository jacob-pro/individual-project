...
One issue I found was that I had to manually inspect the output logs of the \texttt{run\_script}
...
dependency and get the installation working again\footnote{See \texttt{examples/dp3t/no\_bintray.patch}}. \\
...
process I added to one of the guides (\url{https://github.com/madeindra/signal-setup-guide/pull/83}).
